# This version of the code adds some internal processing steps into the model that 
# implemeent attractor net dynamics. Training is via the single objective of predicting
# parity
